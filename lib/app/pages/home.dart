              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    //buildContainerBottomNav(Icons.notifications_on, 'notification', context),
                          ...
                          child: Row(
                            children: [
                              buildBottomContainer("4",
                                  "Easy Chilli", "Author"),
                              buildBottomContainer("5",
                                  "Very green peas", "Author"),
                              buildBottomContainer("6",
                                  "Organic eggplants", "Author"),
                            ],
                          ),
                        ),
                        SizedBox(
          ...
          children: [
            ClipRRect(
                ...
                child: SizedBox(
                    height: 130,
                    width: 100,
                    child: Image.asset("assets/images/blog$image.jpg", fit: BoxFit.cover))),
            Padding(
      ...
      child: Row(
        children: [
          SizedBox(
            ...
            buildColumnWithRow(
                "1",
                "Fresh from Home",context),
          
          buildColumnWithRow("2",
              "The Real Veggies",context),
          buildColumnWithRow(
              "3", "My small farm",context),
        ],
      ),
    );
  }
   GestureDetector buildColumnWithRow(String image, String title, BuildContext context) {
